...
class MyProblem(text_problems.Text2TextProblem):
    ...
    def generate_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        # q_r = open("./rawdata/q.txt", encoding='gb18030', errors='ignore')
        # a_r = open("./rawdata/a.txt", encoding='gb18030', errors='ignore')
        q_r = open("./rawdata/q.txt", 'rb')
        a_r = open("./rawdata/a.txt", 'rb')
